var ChatbotSDK=(()=>{var J=Object.defineProperty;var be=Object.getOwnPropertyDescriptor;var ye=Object.getOwnPropertyNames;var xe=Object.prototype.hasOwnProperty;var ve=(e,t)=>{for(var n in t)J(e,n,{get:t[n],enumerable:!0})},we=(e,t,n,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let c of ye(t))!xe.call(e,c)&&c!==n&&J(e,c,{get:()=>t[c],enumerable:!(o=be(t,c))||o.enumerable});return e};var _e=e=>we(J({},"__esModule",{value:!0}),e);var Oe={};ve(Oe,{ChatbotSDK:()=>he,init:()=>fe});function Q(e){let t=document.createElement("link");t.rel="stylesheet",t.href=e,document.head.appendChild(t)}function ee(){Q("https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.2/font/bootstrap-icons.min.css"),Q("https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;700&display=swap")}function te(){let e=`
  ...
  `,o=document.createElement("style");o.type="text/css",o.appendChild(document.createTextNode(e)),document.head.appendChild(o)}function oe(e){e&&document.documentElement.style.setProperty("--brand",e)}var q=class{constructor(t,n,o){this.root=t,this.routes=n||{},this.currentPage="welcome",this.onRendered=o,localStorage.setItem("chatbot_current_page",this.currentPage)}getPage(){return this.currentPage}setPage(t){this.currentPage=t,this.render()}render(){let t=this.getPage(),n=this.routes[t]||this.routes.welcome;this.root.innerHTML=typeof n=="function"?n():n,typeof this.onRendered=="function"&&this.onRendered(this),localStorage.setItem("chatbot_current_page",this.currentPage)}};function ne(e="Zentrova"){return{welcome:()=>`
    ...
    `}}function ke(e){try{if(!e||e.length!==2)return"";let t=[...e.toUpperCase()].map(n=>127397+n.charCodeAt(0));return String.fromCodePoint(...t)}catch{return""}}async function j(e,t="+234"){let n=document.getElementById(e);if(n){try{n.innerHTML='<option value="">Loading countries...</option>'}catch{}try{let o=await fetch("https://restcountries.com/v3.1/all?fields=name,cca2,idd");if(!o.ok)throw new Error("Failed to fetch countries");let c=await o.json(),i=[];for(let s of c){let u=s?.name?.common||"",r=s?.cca2||"",d=s?.idd?.root||"",p=Array.isArray(s?.idd?.suffixes)?s.idd.suffixes:[];if(!u||!d||p.length===0)continue;let _=ke(r);for(let h of p){let b=`${d}${h}`;i.push({name:u,dial:b,flag:_})}}i.sort((s,u)=>s.name.localeCompare(u.name));let a="";for(let s of i){let u=s.dial===t?" selected":"",r=`${s.flag?s.flag+" ":""}${s.name} (${s.dial})`;a+=`<option value="${s.dial}"${u}>${r}</option>`}if(a)n.innerHTML=a;else throw new Error("No countries with dialing codes")}catch(o){console.warn("Country population failed:",o?.message||o);try{(!n.innerHTML||n.innerHTML.includes("Loading countries"))&&(n.innerHTML=['<option value="+234">\u{1F1F3}\u{1F1EC} Nigeria (+234)</option>','<option value="+1">\u{1F1FA}\u{1F1F8} United States (+1)</option>','<option value="+44">\u{1F1EC}\u{1F1E7} United Kingdom (+44)</option>'].join(""))}catch{}}}}var G="https://api.zentai.cloud/api/v1",ae="https://chatbot.zentai.cloud/",H=null,K=null,z=null,V=null,Y=null,Ee=!1,N=!1,W=!1,U=null,C=null,I=null,T=null,M=null,P=null,R=null,O=null,L=null,$=Date.now(),A=null,X=!1;function F(){$=Date.now()}function ce(){try{W=!0,V&&(V.disconnect(),V=null),z&&(z.disconnect(),z.mediaStream&&z.mediaStream.getTracks().forEach(e=>e.stop()),z=null);try{U&&(U.stop(),U.disconnect())}catch{}if(U=null,Ie=[],Ce=!1,Be=0,K){try{K.close()}catch{}K=null}if(H){try{H.readyState===WebSocket.OPEN&&H.close(1e3,"User ended call")}catch{}H=null}Y&&(clearInterval(Y),Y=null);try{if(I){try{I.close()}catch{}I=null}if(C){try{C.close()}catch{}C=null}if(T){try{T.getTracks().forEach(t=>t.stop())}catch{}T=null}let e=document.getElementById("assistantAudio");e&&(e.srcObject=null),O&&(cancelAnimationFrame(O),O=null);try{P&&P.disconnect()}catch{}P=null;try{R&&R.disconnect()}catch{}if(R=null,M){try{M.close()}catch{}M=null}L!=null&&(clearInterval(L),L=null),X=!1}catch{}Ee=!1,N=!1}catch{}}function Se(){let e=localStorage.getItem("chatbot_session_id");return e||(e="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){let n=Math.random()*16|0;return(t==="x"?n:n&3|8).toString(16)}),localStorage.setItem("chatbot_session_id",e)),e}function D(e,t={}){try{window.dispatchEvent(new CustomEvent("chatbot-call-status",{detail:{status:e,...t}}))}catch{}}var Ie=[],Ce=!1,Be=0;function re(e,t){let n=e.getPage();if(n==="call-welcome"){let o=document.getElementById("call-welcome-back"),c=document.getElementById("call-welcome-start");o&&o.addEventListener("click",()=>e.setPage("welcome")),c&&c.addEventListener("click",()=>e.setPage("precall"));let i=document.getElementById("footer-call"),a=document.getElementById("footer-chat");i&&i.classList.add("active"),a&&a.classList.remove("active"),a&&a.addEventListener("click",()=>e.setPage("prechat"));return}if(n==="precall"){let d=function(){let h=(a&&a.value||"").trim(),k=(u&&u.value||"").trim().length>=7,f=!!(r&&r.checked)},p=function(h){c&&(c.disabled=!!h);let b=document.querySelector(".precall-card");b&&(b.style.pointerEvents=h?"none":"auto"),b&&(b.style.opacity=h?"0.6":"1")},o=document.getElementById("precall-form"),c=document.getElementById("precall-start"),i=document.getElementById("precall-back"),a=document.getElementById("precall-name"),s=document.getElementById("precall-country"),u=document.getElementById("precall-phone"),r=document.getElementById("precall-consent");j("precall-country","+234"),d(),a&&a.addEventListener("input",d),u&&u.addEventListener("input",d),s&&s.addEventListener("change",d),r&&r.addEventListener("change",d);async function _(){if(N)return;N=!0,p(!0);let h=(document.getElementById("precall-name").value||"Guest").trim(),b=document.getElementById("precall-country").value||"",k=(document.getElementById("precall-phone").value||"").trim(),f=localStorage.getItem("chatbot_user_question")||"Start call";try{localStorage.setItem("chatbot_user_name",h),localStorage.setItem("chatbot_user_phone",`${b}${k}`),localStorage.setItem("chatbot_user_question",f)}catch{}let y=t&&t.chatbotID||localStorage.getItem("chatbot_id");if(!y){console.error("Missing chatbotID"),N=!1,p(!1);return}try{let l=await fetch(`${G}/chatbots/call/${encodeURIComponent(y)}/start/`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({user_phone:`${b}${k}`,user_name:h??"Guest"})});if(!l.ok)throw new Error("Call init failed");let m=await l.json();try{let S=m&&(m.call_id||m.conversation_id||m.id);S&&localStorage.setItem("chatbot_conversation_id",String(S))}catch{}let g=t&&t.bot,w=y,x=g&&g.language||localStorage.getItem("chatbot_bot_language")||"English",E=g&&g.voice||localStorage.getItem("chatbot_bot_voice")||"alloy",v=g&&g.welcome_message||localStorage.getItem("chatbot_bot_welcome_message")||"Hello! How can I assist you today?";await new Promise(S=>setTimeout(S,200)),Ae({agentId:w,language:x,voice:E,welcomeMessage:v}),e.setPage("call")}catch(l){console.error("Init call error:",l),D("error",{error:l?.message||"Initialization failed"}),alert("Unable to start call. Please try again.")}finally{N=!1,p(!1)}}o&&o.addEventListener("submit",h=>{h.preventDefault(),!(c&&c.disabled)&&_()}),c&&c.addEventListener("click",h=>{h.preventDefault(),!(c&&c.disabled)&&_()}),i&&i.addEventListener("click",()=>e.setPage("call-welcome"));return}if(n==="call"){let a=function(u){let d=(u.detail||{}).status,p=document.getElementById("call-connecting");p&&(d==="connected"||d==="configured"?p.style.display="none":d==="connecting"&&(p.style.display="block"))},o=document.getElementById("call-back"),c=document.getElementById("call-end"),i=document.getElementById("call-connecting");i&&(i.style.display="block"),window.addEventListener("chatbot-call-status",a);async function s(){try{let r=localStorage.getItem("chatbot_conversation_id");if(r){await fetch(`${G}/chatbots/call/${encodeURIComponent(r)}/complete/`,{method:"POST",headers:{"Content-Type":"application/json"}});try{localStorage.removeItem("chatbot_conversation_id")}catch{}}else{let d=Se();await fetch(`${G}/chatbots/conversations/${encodeURIComponent(d)}/end/`,{method:"POST",headers:{"Content-Type":"application/json"}})}}catch{}W=!0,ce();let u=null;try{u=localStorage.getItem("chatbot_transfer_phone_number")}catch{}u?(e.setPage("postcall-transfer"),console.log()):e.setPage("call-welcome")}A=s,o&&o.addEventListener("click",u=>{u.preventDefault(),s()}),c&&c.addEventListener("click",u=>{u.preventDefault(),s()});return}if(n==="postcall-transfer"){let o=document.getElementById("transfer-call-now"),c=document.getElementById("transfer-close"),i=null;try{i=localStorage.getItem("chatbot_transfer_phone_number")}catch{}o&&o.addEventListener("click",()=>{if(i)try{window.location.href=`tel:${i}`}catch{}try{localStorage.removeItem("chatbot_transfer_phone_number")}catch{}try{document.body.classList.remove("show-chatbot")}catch{}e.setPage("call-welcome")}),c&&c.addEventListener("click",()=>{try{localStorage.removeItem("chatbot_transfer_phone_number")}catch{}try{document.body.classList.remove("show-chatbot")}catch{}e.setPage("call-welcome")});return}}async function Le(e,t,n,o){let c=`${ae}realtime/token`,i=null;try{let r=localStorage.getItem("chatbot_custom_apis"),d=r?JSON.parse(r):null;i=Array.isArray(d)&&d.length>0?d:null}catch{i=null}let a={};e&&(a.agent_id=e),n&&(a.voice=n),t&&(a.language=t),o&&(a.welcome_message=o),i&&(a.custom_apis=i);let s=await fetch(c,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(!s.ok){let r=await s.text();throw new Error(`Failed to obtain token: ${r}`)}let u=await s.json();if(!u.value)throw new Error("Token response missing value field");return u.value}async function Pe(e,t,n){try{let o=JSON.parse(n||"{}");if(o&&o.transfer_phone_number){let a=String(o.transfer_phone_number);try{localStorage.setItem("chatbot_transfer_phone_number",a)}catch{}}let c=await fetch(`${ae}realtime/function-call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({function_name:e,arguments:o})});if(!c.ok)throw new Error(`Function call failed: ${c.statusText}`);let i=await c.json();if(I&&I.readyState==="open"){let a={type:"conversation.item.create",item:{type:"function_call_output",call_id:t,output:JSON.stringify(i)}};I.send(JSON.stringify(a)),I.send(JSON.stringify({type:"response.create"}))}}catch(o){if(I&&I.readyState==="open"){let c={type:"conversation.item.create",item:{type:"function_call_output",call_id:t,output:JSON.stringify({error:o?.message||"Function call error"})}};I.send(JSON.stringify(c))}}}async function Ae({agentId:e,language:t,voice:n,welcomeMessage:o}){try{let d=function(){X||(X=!0,$=Date.now(),L&&clearInterval(L),L=setInterval(()=>{if(W)return;Date.now()-$>=IDLE_TIMEOUT_MS&&A&&A()},1e3))};D("connecting");let c=document.getElementById("call-connecting");c&&(c.style.display="block");let i=localStorage.getItem("chatbot_id")||e,a=localStorage.getItem("chatbot_bot_voice")||n,s=localStorage.getItem("chatbot_bot_language")||t,u=localStorage.getItem("chatbot_bot_welcome_message")||o,r=await Le(i,s,a,u);C=new RTCPeerConnection({iceServers:[{urls:["stun:stun.l.google.com:19302"]}]}),C.addEventListener("iceconnectionstatechange",()=>{let f=C.iceConnectionState;(f==="disconnected"||f==="failed")&&A&&A()}),T=await navigator.mediaDevices.getUserMedia({audio:!0,video:!1}),T.getTracks().forEach(f=>C.addTrack(f,T)),C.addEventListener("track",f=>{let[y]=f.streams,l=document.getElementById("assistantAudio");l&&(l.srcObject=y);let m=y&&y.getAudioTracks&&y.getAudioTracks()[0];m&&(m.onunmute=()=>{F(),d();let g=document.getElementById("call-connecting");g&&(g.style.display="none"),D("streaming")});try{let g=function(){let w=new Uint8Array(P.frequencyBinCount);P.getByteTimeDomainData(w);let x=0;for(let v=0;v<w.length;v++){let S=(w[v]-128)/128;x+=S*S}Math.sqrt(x/w.length)>.02&&F(),O=requestAnimationFrame(g)};M=new(window.AudioContext||window.webkitAudioContext),R=M.createMediaStreamSource(y),P=M.createAnalyser(),P.fftSize=256,R.connect(P),O=requestAnimationFrame(g)}catch{}}),I=C.createDataChannel("oai-events"),I.onopen=()=>{F(),d();try{I.send(JSON.stringify({type:"response.create"}))}catch{}},I.onmessage=f=>{F(),d();try{let y=JSON.parse(f.data);if(y.type==="response.function_call_arguments.done"){let{name:l,call_id:m,arguments:g}=y;Pe(l,m,g)}}catch{}};let p=await C.createOffer();await C.setLocalDescription(p);let h=await fetch("https://api.openai.com/v1/realtime/calls",{method:"POST",headers:{Authorization:`Bearer ${r}`,"Content-Type":"application/sdp"},body:C.localDescription?.sdp||""});if(!h.ok)throw new Error("SDP exchange failed");let b=await h.text(),k=new RTCSessionDescription({type:"answer",sdp:b});await C.setRemoteDescription(k),L&&clearInterval(L),$=Date.now(),L=setInterval(()=>{if(W)return;Date.now()-$>=1e4&&A&&A()},1e3),D("connected")}catch(c){console.error("LiveCall start error:",c),D("error",{error:c?.message||"RTC start failed"}),ce()}}function pe(e){let t=document.querySelector(".chatbot-toggler"),n=document.querySelector(".chat-actions"),o=t?t.querySelector("i"):null,c=document.querySelector(".pill-btn");function i(){o&&(o.className=n.classList.contains("show")?"bi bi-x-lg":"bi bi-chat-dots")}t&&t.addEventListener("click",()=>{n.classList.toggle("show")||n.classList.remove("show"),i()});let a=document.getElementById("pill-toggle");a&&a.addEventListener("click",()=>{let r=e.getPage();r&&localStorage.setItem("chatbot_prev_page",r),document.body.classList.remove("show-chatbot"),i()}),c&&c.addEventListener("click",r=>{r.preventDefault();try{window.open("https://share-eu1.hsforms.com/2U7ipluaKRqy_okiu5ErdUA2es2nu","_blank","noopener,noreferrer")}catch{window.location.href="https://share-eu1.hsforms.com/2U7ipluaKRqy_okiu5ErdUA2es2nu"}});let s=document.getElementById("action-chat"),u=document.getElementById("action-call");s&&s.addEventListener("click",()=>{n.classList.remove("show"),document.body.classList.add("show-chatbot"),i();let r=localStorage.getItem("chatbot_current_page"),d=localStorage.getItem("chatbot_user_name");e.setPage(r==="chat"||d?"chat":"welcome")}),u&&u.addEventListener("click",()=>{n.classList.remove("show"),document.body.classList.add("show-chatbot"),i(),e.setPage("call-welcome")})}function B(e,t){let n=document.querySelector(".chatbox");if(!n)return;let o=document.createElement("li");if(t==="typing")o.className="chat typing",o.innerHTML='<i class="bi bi-robot"></i><p class="typing"><span></span><span></span><span></span></p>';else{let c=t==="error"?"error":t;o.className=`chat ${c}`,c==="incoming"?o.innerHTML=`<i class="bi bi-robot"></i><div class="bubble">${Te(e)}</div>`:c==="error"?o.innerHTML=`<i class="bi bi-robot"></i><p>${Z(e).replace(/\n/g,"<br>")}</p>`:o.innerHTML=`<p>${Z(e).replace(/\n/g,"<br>")}</p>`}return n.appendChild(o),n.scrollTop=n.scrollHeight,o}function Z(e){return(e||"").replace(/[&<>]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[t])}function Te(e){let n=Z(e||"").split(`
`),o="",c=!1,i=null;function a(){i&&(o+=`</${i}>`,i=null)}function s(u){return u.replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>")}for(let u=0;u<n.length;u++){let r=n[u];if(r.trim().startsWith("```")){c?(c=!1,o+="</code></pre>"):(a(),c=!0,o+="<pre><code>");continue}if(c){o+=r+`
`;continue}if(/^###\s+/.test(r)){a(),o+="<h3>"+r.replace(/^###\s+/,"")+"</h3>";continue}if(/^##\s+/.test(r)){a(),o+="<h2>"+r.replace(/^##\s+/,"")+"</h2>";continue}if(/^#\s+/.test(r)){a(),o+="<h1>"+r.replace(/^#\s+/,"")+"</h1>";continue}if(/^\s*\d+\.\s+/.test(r)){let d=r.replace(/^\s*\d+\.\s+/,"");i!=="ol"&&(a(),i="ol",o+="<ol>"),o+="<li>"+s(d)+"</li>";continue}if(/^\s*[-*]\s+/.test(r)){let d=r.replace(/^\s*[-*]\s+/,"");i!=="ul"&&(a(),i="ul",o+="<ul>"),o+="<li>"+s(d)+"</li>";continue}if(r.trim()===""){a();continue}a(),o+="<p>"+s(r)+"</p>"}return a(),o}function me(e){return`chatbot_history_${e||"default"}`}function se(e){try{return JSON.parse(localStorage.getItem(me(e)))||[]}catch{return[]}}function ie(e,t){try{localStorage.setItem(me(e),JSON.stringify(t))}catch{}}function le(e){e.forEach(t=>B(t.text,t.type))}var de="https://api.zentai.cloud/api/v1";function ge(e,t){let n=e.getPage(),o=t&&t.bot,c=t&&t.chatbotID,i=o&&o.welcome_message||"Hello! How can I help you today?";if(n==="welcome"){let a=document.getElementById("start-conversation");a&&a.addEventListener("click",()=>e.setPage("prechat"));let s=document.getElementById("footer-chat");s&&s.addEventListener("click",()=>e.setPage("prechat"));let u=document.getElementById("footer-call");u&&u.addEventListener("click",()=>e.setPage("call-welcome"))}else if(n==="call-welcome"){let a=document.getElementById("call-welcome-back"),s=document.getElementById("call-welcome-start");a&&a.addEventListener("click",()=>e.setPage("welcome")),s&&s.addEventListener("click",()=>e.setPage("precall"));let u=document.getElementById("footer-call"),r=document.getElementById("footer-chat");u&&u.classList.add("active"),r&&r.classList.remove("active"),r&&r.addEventListener("click",()=>e.setPage("prechat"))}else if(n==="prechat"){let h=function(l){return/.+@.+\..+/.test((l||"").trim())},b=function(){let l=(u&&u.value||"").trim(),m=(r&&r.value||"").trim(),g=d&&d.value||"",w=(p&&p.value||"").trim(),x=(_&&_.value||"").trim(),E=w.length>=7,v=!!l&&h(m)&&!!g&&E&&!!x;s&&(s.disabled=!v)},a=document.getElementById("prechat-form");j("country-code","+234");let s=document.getElementById("start-chat-btn"),u=document.getElementById("prechat-name"),r=document.getElementById("prechat-email"),d=document.getElementById("country-code"),p=document.getElementById("prechat-phone"),_=document.getElementById("prechat-question");b(),u&&u.addEventListener("input",b),r&&r.addEventListener("input",b),d&&d.addEventListener("change",b),p&&p.addEventListener("input",b),_&&_.addEventListener("input",b),a&&a.addEventListener("submit",l=>{if(l&&l.preventDefault&&l.preventDefault(),s&&s.disabled)return;let m=(document.getElementById("prechat-name").value||"Guest").trim(),g=(document.getElementById("prechat-email").value||"None").trim(),w=document.getElementById("country-code").value||"",x=(document.getElementById("prechat-phone").value||"").trim(),E=(document.getElementById("prechat-question").value||"").trim();localStorage.setItem("chatbot_user_name",m),localStorage.setItem("chatbot_user_email",g),localStorage.setItem("chatbot_user_phone",`${w}${x}`),localStorage.setItem("chatbot_user_question",E),e.setPage("chat")}),s&&s.addEventListener("click",()=>{let l=document.getElementById("prechat-form");s&&s.disabled||l&&l.dispatchEvent(new Event("submit"))});let k=document.getElementById("prechat-back-btn");k&&k.addEventListener("click",()=>e.setPage("welcome"));let f=document.getElementById("footer-chat"),y=document.getElementById("footer-call");f&&f.addEventListener("click",()=>e.setPage("prechat")),y&&y.addEventListener("click",()=>e.setPage("precall")),f&&f.classList.add("active"),y&&y.classList.remove("active")}else if(n==="chat"){let b=function(){let l=localStorage.getItem("chatbot_session_id");return l||(l="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(m){let g=Math.random()*16|0;return(m==="x"?g:g&3|8).toString(16)}),localStorage.setItem("chatbot_session_id",l)),l},k=function(l,m){m!=="error"&&(d.push({text:l,type:m,ts:Date.now()}),ie(c,d))},a=localStorage.getItem("chatbot_user_name")||"Guest",s=localStorage.getItem("chatbot_user_email")||"",u=localStorage.getItem("chatbot_user_phone")||"",r=localStorage.getItem("chatbot_user_question")||"",d=se(c);d.length>0?le(d):B(i,"incoming");let p=document.getElementById("chat-input"),_=document.getElementById("send-btn"),h=document.getElementById("attach-btn");async function f(l){B(l,"outgoing"),k(l,"outgoing");let m=document.querySelector(".chatbox li:last-child");if(m&&m.classList.contains("outgoing")){let x=document.createElement("span");x.className="sender-tag",x.textContent=a||"You",m.appendChild(x)}let g=ue(),w={session_id:b(),message:l,user_email:s??"Guest",user_name:a??"Guest",user_phone:u};try{if(!c)throw new Error("Missing chatbotID");let x=await fetch(`${de}/chatbots/widget/${encodeURIComponent(c)}/chat/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(w)}),E=x.ok,v=E?await x.json():null;if(g(),!E)throw new Error("Request failed");let S=v&&v.bot_message&&v.bot_message.message||v?.data?.response||v?.response||v?.message||"Okay.";B(S,"incoming"),k(S,"incoming")}catch{g(),B("Could not process your request at the moment. Please try again.","error")}}r&&d.length===0&&f(r),_&&_.addEventListener("click",()=>{let l=(p&&p.value||"").trim();l&&(p.value="",f(l))}),p&&p.addEventListener("keydown",l=>{if(l.key==="Enter"&&!l.shiftKey){l.preventDefault();let m=(p&&p.value||"").trim();if(!m)return;p.value="",f(m)}}),h&&h.addEventListener("click",()=>{});let y=document.getElementById("chat-back-btn");y&&y.addEventListener("click",()=>e.setPage("prechat"))}else{if(n==="call-welcome"||n==="precall"||n==="call"||n==="postcall-transfer")return re(e,t);if(n==="prechat"){let a=document.getElementById("prechat-form");a&&a.addEventListener("submit",()=>{let p=(document.getElementById("prechat-name").value||"").trim(),_=(document.getElementById("prechat-email").value||"").trim(),h=document.getElementById("country-code").value||"",b=(document.getElementById("prechat-phone").value||"").trim(),k=(document.getElementById("prechat-question").value||"").trim();localStorage.setItem("chatbot_user_name",p??"Guest"),localStorage.setItem("chatbot_user_email",_),localStorage.setItem("chatbot_user_phone",`${h}${b}`),localStorage.setItem("chatbot_user_question",k),e.setPage("chat")});let s=document.getElementById("start-chat-btn");s&&s.addEventListener("click",()=>{let p=document.getElementById("prechat-form");p&&p.dispatchEvent(new Event("submit"))});let u=document.getElementById("prechat-back-btn");u&&u.addEventListener("click",()=>e.setPage("welcome"));let r=document.getElementById("footer-chat"),d=document.getElementById("footer-call");r&&r.addEventListener("click",()=>e.setPage("prechat")),d&&d.addEventListener("click",()=>e.setPage("precall")),r&&r.classList.add("active"),d&&d.classList.remove("active")}else if(n==="chat"){let b=function(){let l=localStorage.getItem("chatbot_session_id");return l||(l="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(m){let g=Math.random()*16|0;return(m==="x"?g:g&3|8).toString(16)}),localStorage.setItem("chatbot_session_id",l)),l},k=function(l,m){m!=="error"&&(d.push({text:l,type:m,ts:Date.now()}),ie(c,d))},a=localStorage.getItem("chatbot_user_name")||"Guest",s=localStorage.getItem("chatbot_user_email")||"",u=localStorage.getItem("chatbot_user_phone")||"",r=localStorage.getItem("chatbot_user_question")||"",d=se(c);d.length>0?le(d):B(i,"incoming");let p=document.getElementById("chat-input"),_=document.getElementById("send-btn"),h=document.getElementById("attach-btn");async function f(l){B(l,"outgoing"),k(l,"outgoing");let m=document.querySelector(".chatbox li:last-child");if(m&&m.classList.contains("outgoing")){let x=document.createElement("span");x.className="sender-tag",x.textContent=a||"You",m.appendChild(x)}let g=ue(),w={session_id:b(),message:l,user_email:s,user_name:a,user_phone:u};try{if(!c)throw new Error("Missing chatbotID");let x=await fetch(`${de}/chatbots/widget/${encodeURIComponent(c)}/chat/`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(w)}),E=x.ok,v=E?await x.json():null;if(g(),!E)throw new Error("Request failed");let S=v&&v.bot_message&&v.bot_message.message||v?.data?.response||v?.response||v?.message||"Okay.";B(S,"incoming"),k(S,"incoming")}catch{g(),B("Could not process your request at the moment. Please try again.","error")}}r&&d.length===0&&f(r),_&&_.addEventListener("click",()=>{let l=(p&&p.value||"").trim();l&&(p.value="",f(l))}),p&&p.addEventListener("keydown",l=>{if(l.key==="Enter"&&!l.shiftKey){l.preventDefault();let m=(p&&p.value||"").trim();if(!m)return;p.value="",f(m)}}),h&&h.addEventListener("click",()=>{});let y=document.getElementById("chat-back-btn");y&&y.addEventListener("click",()=>e.setPage("prechat"))}else if(n==="call-welcome"){let a=document.getElementById("call-back"),s=document.getElementById("call-end");a&&a.addEventListener("click",()=>e.setPage("call-welcome")),s&&s.addEventListener("click",()=>e.setPage("call-welcome"))}}}function ue(){let e=B("","typing");return function(){e&&e.parentNode&&e.parentNode.removeChild(e)}}window.addEventListener("chatbot-call-status",e=>{});window.addEventListener("chatbot-call-status",e=>{let t=e?.detail?.status||"",n=document.getElementById("call-end"),o=t==="connecting";n&&(n.classList.toggle("loading",o),n.disabled=o)});var Me="Zentrova",ze="https://api.zentai.cloud/api/v1";function Ne(){let e=document.createElement("button");e.className="chatbot-toggler",e.setAttribute("aria-label","Open chat"),e.innerHTML='<i class="bi bi-chat-dots"></i>';let t=document.createElement("div");t.className="chat-actions",t.innerHTML=`
